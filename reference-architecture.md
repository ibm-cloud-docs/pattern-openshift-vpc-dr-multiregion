...
| Resiliency | [ODF Disaster Recovery](https://cloud.ibm.com/docs/openshift?topic=openshift-ocs-storage-prep){: external} | Disaster Recovery Supports HA across Availability Zones, RPO-zero failover across data centers in a metropolitan area and continuous incremental backups across global data centers.  |
